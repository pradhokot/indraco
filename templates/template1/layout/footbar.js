document.writeln(`
<div class="footbar text-bg-light small">
   <div class="container py-5">
      <div class="row g-0 row-gap-4 column-gap-md-5 justify-content-lg-between">
         <div class="col col-12 col-lg-auto order-lg-1">
            <div class="d-flex flex-wrap align-items-center flex-lg-column">
               <div class="me-auto">
                  <img src="../../asset/img/logo-indraco-dark.png" width="100%" height="auto" alt="" style="max-width: 12.75rem;">
                  <p class="lh-1">
