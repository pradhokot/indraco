   ...
   <div class="navbar-top">
      <div class="container py-3 pb-lg-2 pt-lg-5">
         ...
         <div class="navtop-end">
            <div class="float-end">
               <div class="d-lg-none">
                  <script src="component/trigger-search.js"></script>
               </div>
               <div class="d-none d-lg-block small">
                  <script src="component/submenu.js"></script>
               </div>
            </div>
         </div>
      </div><!-- end container -->
         ...
         <div class="offcanvas-body py-0">
            <ul class="navbar-nav py-0">
               ...
               <li class="nav-item dropdown">
                  ...
                  <script src="component/collapse-products.js"></script>
               </li>
               <li class="nav-item d-none d-lg-block position-relative">
                  <div class="vr h-75 position-absolute top-50 start-50 translate-middle"></div>
               </li>
               ...
               <li class="nav-item dropdown">
                  ...
                  <script src="component/collapse-stores.js"></script>
               </li>
               <li class="nav-item d-none d-lg-block position-relative">
                  <div class="vr h-75 position-absolute top-50 start-50 translate-middle"></div>
               </li>
